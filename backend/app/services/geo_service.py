...
CITY_COORDINATES: Dict[str, Tuple[float, float]] = {
    ...
    # Mumbai area mock locations matching frontend
    "bandra west": (19.0595, 72.8295),
    "bkc": (19.0663, 72.8680),
    "andheri east": (19.1197, 72.8469),
    "powai": (19.1176, 72.9060),
    "worli": (19.0177, 72.8182),
    "dadar": (19.0186, 72.8425),
    "malad west": (19.1872, 72.8483),
    "vashi": (19.0759, 73.0078),
