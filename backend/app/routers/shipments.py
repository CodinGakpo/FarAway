...
def create_shipment_request(
    ...
    logger.info(
        "agent_evaluate_start | trip_id=%s origin=%r destination=%r",
        trip.id, trip.origin_name, trip.destination_name,
    )
    ...
    logger.info(
        "agent_evaluate_done | trip_id=%s feasible=%s price=%.2f",
        trip.id, agent_result["feasible"], agent_result["price"],
    )
